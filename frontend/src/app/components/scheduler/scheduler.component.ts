  ...
  template: `
    <div class="placeholder-page">
      <div class="placeholder-card">
        ...
        <h1>Scan Scheduler</h1>
        <p class="subtitle">Automated recurring reconnaissance tasks</p>
        <div class="coming-soon">Coming in v7.0</div>
        <p class="description">
          The Scheduler module will enable automated, recurring scans with cron-like
          scheduling, resource optimization, and intelligent timing to minimize network impact.
        </p>
      </div>
    </div>
  `,
